# Assembled Prompt: Stage 05 Activity Family Batch 001_metabolic_nutrition
...
Batch ID prefix: `b01_nutrition`.

Care domain: 001_metabolic_nutrition.

Theme: metabolic nutrition, structured meals, meal-source logic, supplements or medication tied to food, CGM or hydration support, and travel meal substitutions.

Generate exactly 12 activity families. Each family must have exactly one primary activity. Include 0-3 substitutions only when realistic.

Minimum scheduler-facing activities in this batch: 24.
...
[
  {
    ...
    "primary_intent": "breakfast",
    "primary_role": "core",
    "primary_weekly_frequency_estimate": 5,
    "semantic_notes": [
      "Covers core structured breakfast at home with chef prep or low-prep fallback.",
      "Must not duplicate travel or office breakfast; substitutions only if chef unavailable or time-constrained."
    ],
  ...
  },
  {
    ...
    "primary_intent": "lunch",
    "primary_role": "core",
    "primary_weekly_frequency_estimate": 5,
    "semantic_notes": [
      "Covers core structured lunch via office delivery or chef-prepped packed meal.",
      "Must not duplicate travel or restaurant lunch; substitutions only if delivery unavailable."
    ],
    "substitution_count": 1,
    "substitution_reason_codes": [
      "prep_unavailable",
  ...
  },
  {
    ...
    "primary_role": "core",
    "primary_weekly_frequency_estimate": 4,
    "semantic_notes": [
      "Covers core structured dinner at home with chef prep.",
      "Must not duplicate travel or restaurant dinner; substitutions only if chef unavailable."
    ],
    "substitution_count": 1,
    "substitution_reason_codes": [
      "prep_unavailable",
  ...
  },
  {
    ...
    "primary_intent": "fasting_aware_meal",
    "primary_role": "support",
    "primary_weekly_frequency_estimate": 0,
    "semantic_notes": [
  ...
  },
  {
    ...
    "primary_intent": "supplement_protocol",
    "primary_role": "support",
    "primary_weekly_frequency_estimate": 0,
    "semantic_notes": [
...
Target counts remaining: final merged board needs at least 100 scheduler-facing activities from activity families across all accepted care-domain batches. This batch must provide at least 24 scheduler-facing activities while preserving exactly 12 families. Use the requested prefix exactly and avoid duplicate activity/family IDs.
